...
import { createUserScore } from "../graphql/mutations";
export default function UserScoreCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createUserScore.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserScoreCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
